    ...
    <div class="index-content" id="IndexContent">
        <%--<div class="index-search"> ------------Search
            ...
            <dx:ASPxComboBox ID="SearchComboBox" ClientInstanceName="SearchComboBox" CssClass="combobox" runat="server"
                Width="510px" Height="48px" Font-Size="24px" NullText="Tap to select a location" NullTextDisplayMode="UnfocusedAndFocused"
                DataSourceID="LocationDataSource" ValueField="ID" TextField="Area_Name" ShowShadow="true">
    ...
    <ContentCollection>
        <dx:PopupControlContentControl>
            ...
            <div style="text-align: center">
                ...
                <dx:ASPxImage runat="server" ID="ASPxImage1" ImageUrl="~/Content/Images/BookNow.png">
            ...
            <dx:ASPxFormLayout ID="ASPxFormLayout2" CssClass="form-layout" runat="server" RequiredMarkDisplayMode="None">
                ...
                <Items>
                    <dx:LayoutItem>
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxTextBox ID="LoginEmailTextBox" NullText="Email" NullTextDisplayMode="UnfocusedAndFocused" runat="server" Height="50px" Width="350px" CssClass="login-editor">
                    ...
                    <dx:LayoutItem>
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxTextBox ID="LoginPasswordTextBox" runat="server" Password="true" NullText="Password" NullTextDisplayMode="UnfocusedAndFocused" Height="50px" Width="350px" CssClass="login-editor">
                                    <ClientSideEvents KeyDown="onInputKeyDown" />
                                    <ValidationSettings ValidationGroup="Login" ErrorDisplayMode="None" Display="Dynamic">
                                        <RequiredField IsRequired="true" />
                                    </ValidationSettings>
                        ...
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxTextBox ID="LoginCaptchaEditor" runat="server" NullText="Enter the verification code above to proceed…"
                                    NullTextDisplayMode="UnfocusedAndFocused" Height="50px" Width="350px" CssClass="login-editor">
                                    <ClientSideEvents KeyDown="onInputKeyDown" />
                                    <ValidationSettings ValidationGroup="Login" ErrorDisplayMode="None" Display="Dynamic">
                                        <RequiredField IsRequired="true" />
                                    </ValidationSettings>
